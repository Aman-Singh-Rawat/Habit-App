...
class FocusScreen extends GetView<FocusController> {
  ...
  CustomAppbar appBar() {
    return CustomAppbar(
      title: UserSetupProgressBar(currentStep: 5),
      actions: [UserSetupStepText(currentStep: 5)],
    );
  }
      ...
      child: Column(
        children: [
          ...
          UserSetupTitleSubtitleWidget(
            firstText: AppStrings.doYouOftenFindItHardTo,
            secondText: AppStrings.focus,
            thirdText: AppStrings.focusQuestionMark,
            subtitle: AppStrings.focusSubtitle,
          ),
      ...
      child: Scaffold(
        ...
        bottomSheet: BottomWidget(
          child: ExpandedButton(
            ...
            onPressed: () => Get.toNamed(AppRoutes.influenced),
          ),
        ),
      ),
    );
