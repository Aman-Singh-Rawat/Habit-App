...
class AchieveScreen extends GetView<AchieveController> {
  const AchieveScreen({super.key});

  CustomAppbar appBar() {
    return CustomAppbar(
      title: UserSetupProgressBar(currentStep: 7),
      actions: [UserSetupStepText(currentStep: 7)],
    );
  }
      ...
      child: Column(
        children: [
          ...
          UserSetupTitleSubtitleWidget(
            firstText: AppStrings.whatTimeDoYouWantTo,
            secondText: AppStrings.achieve,
            thirdText: AppStrings.withhabitly,
      ...
      child: Scaffold(
        ...
        bottomSheet: BottomWidget(
          child: ExpandedButton(
            ...
            onPressed: () => Get.toNamed(AppRoutes.contract),
          ),
        ),
      ),
    );
